...
ENV SLIM_VERSION="v5.1" \
    PYTHON_ENV="Python-3.12_msprime-1.3.4_tskit-0.6.4_pyslim-1.1.0_tspop-0.0.2"
...
RUN cd ${HOME}; git clone https://github.com/fil-tel/dotfiles .dotfiles/; rm -f .bashrc .profile; \
